...
Vercel enables developers to host websites and web services that deploy instantly and scale automatically, but also provides more features like instances for building website (CI/CD feature).
Vercel's GitHub Integration automatically deploys changes to my website whenever I push them to my main GitHub branch. This frees me up to focus on coding while Vercel handles continuous deployment and all of the other complexity that come with maintaining a globally dispersed website.
For the steps on how to setup your vercel application it's very simple, For more information you can find their documentation [Here](https://vercel.com/docs).
