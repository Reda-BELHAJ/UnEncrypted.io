...
I use **Firebase** as my database, to store stuff like the # of views each post has. and other plugins and dependencies like (`react-icons`, `use-sound`, `gray-matter` etc...)
