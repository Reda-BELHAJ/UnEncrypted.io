...
date: "07-10-2021"
author: "Reda BELHAJ"
summary: "My personal blog project build with Next.js and Tailwind Css which takes the content from makdown files and renders it using Next.js. Supports dark mode and easy to write blogs using markdown. So In this article, I'm going to break down how my blog works and why i build it."
